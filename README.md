...
| **[Problem 2](./src/problem2/README.md)** | 99TechSwap — currency-swap form with multi-DEX comparison, live insufficient-balance feedback, and quote countdown | Vite, React 18, TypeScript strict, Tailwind, RHF + Zod, TanStack Query, Vitest | [`src/problem2/`](./src/problem2/) |
